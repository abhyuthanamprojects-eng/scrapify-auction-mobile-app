...
class TeamMember extends Equatable {
  ...
  const TeamMember({
    ...
    required this.role,
    this.maxBiddingLimitInr = 2500000,
    this.isActive = true,
    this.joinedAt = '2026-08-01',
    this.allowedCategories = const ['All Categories'],
  });
  ...
  factory TeamMember.fromJson(Map<String, dynamic> json) => TeamMember(
        ...
        maxBiddingLimitInr: (json['max_bidding_limit_inr'] as num?)?.toDouble() ?? 2500000,
  ...
  @override
  List<Object?> get props => [id, name, email, role, isActive, maxBiddingLimitInr];
}
