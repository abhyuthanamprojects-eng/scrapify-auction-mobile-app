                ...
                if (!_paid)
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text(
                                          'Payment must be confirmed by the server before this screen updates.',
                                        ),
                                      ),
                                    );
                                  },
                                  ...
                                  onTap: () async {
                                    final picked =
                                        await AppFilePicker.showPickerBottomSheet(
                                          context,
                                          title:
                                              'Upload Balance Payment Slip (NEFT/RTGS)',
                                        );
                                    if (picked != null) {
                                      if (context.mounted) {
                                        ScaffoldMessenger.of(
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Payment slip "${picked.name}" requires server verification.',
                                            ),
                                          ),
                                        );
                                      }
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: AppColors.successWithOpacity(0.25),
                      ),
                    ),
                    child: Row(
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: AppTextStyles.body(
                                  size: 11,
                                  color: AppColors.successWithOpacity(0.8),
                                ),
                              ),
                            ],
                          ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (slots.isEmpty)
                          Text(
                            'No lifting slots have been published for this award.',
                            style: AppTextStyles.body(
                              size: 12,
                              color: AppColors.navyWithOpacity(0.55),
                            ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                  'Gate pass will appear after server issuance.',
                                ),
                                const SizedBox(height: 2),
                                Text(
