                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: authState.authState == AuthState.loading ? null : _loginWithOtp,
                      style: OutlinedButton.styleFrom(
                        side: const BorderSide(color: AppColors.navy),
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppSpacing.radiusXl)),
                      ),
                      child: const Text('Sign In with OTP', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.navy)),
                    ),
                  ),
                  const SizedBox(height: 20),
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: const Text('Create one', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.auction)),
                      ),
                    ],
                  ),
                ],
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _isBuyer ? AppColors.white : AppColors.textSecondary,
                    ),
                  ),
                ),
              ),
